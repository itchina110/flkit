...
module.exports = think.Class(base, {
  ...
  compressInlineCss: function(token){
    ...
    if (think.isFunction(callback)) {
      return start + callback(content, contentToken, this) + end;
    }
