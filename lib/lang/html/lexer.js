...
module.exports = think.Class(lexer, {
  ...
  getRawToken: function(){
    var i = 0, item, pos = 0, code, startToken, content, endToken;
    /*jshint -W084 */
    for(;item = rawTokens[i++];){
      ...
      content = this.forward(pos - this.pos);
      endToken = this.getTagToken();
      return this.getToken(item[2], startToken.value + content + endToken.value, {
        start: startToken,
        content: content,
        end: endToken
      })
